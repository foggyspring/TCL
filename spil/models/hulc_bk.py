...
class Hulc(pl.LightningModule):
    ...
    def __init__(
        ...
        #use lang vis temporal contrastive loss
        ...
        self.temporal_contrastive_loss_beta = temporal_contrastive_loss_beta 
        self.use_temporal_contrastive_loss = use_temporal_contrastive_loss # true
        self.use_lang_vis_temporal_contrastive_loss = use_lang_vis_temporal_contrastive_loss
    ...
    def training_step(self, batch: Dict[str, Dict], batch_idx: int) -> torch.Tensor:  # type: ignore
        ...
        use_lang = self.current_epoch > self.switch_epoch
